...
mrb_mruby_gles_gem_gl2_init(mrb_state* mrb)
{
  ...
  /* GL core functions */
  mrb_define_module_function(mrb, mod_gl2, "glActiveTexture", mrb_gl_active_texture, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glAttachShader", mrb_gl_attach_shader, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBindAttribLocation", mrb_gl_bind_attrib_location, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glBindBuffer", mrb_gl_bind_buffer, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBindFramebuffer", mrb_gl_bind_framebuffer, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBindRenderbuffer", mrb_gl_bind_renderbuffer, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBindTexture", mrb_gl_bind_texture, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBlendColor", mrb_gl_blend_color, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glBlendEquation", mrb_gl_blend_equation, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glBlendEquationSeparate", mrb_gl_blend_equation_separate, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBlendFunc", mrb_gl_blend_func, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glBlendFuncSeparate", mrb_gl_blend_func_separate, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glBufferData", mrb_gl_buffer_data, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glBufferSubData", mrb_gl_buffer_sub_data, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glCheckFramebufferStatus", mrb_gl_check_framebuffer_status, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glClear", mrb_gl_clear, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glClearColor", mrb_gl_clear_color, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glClearDepthf", mrb_gl_clear_depthf, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glClearStencil", mrb_gl_clear_stencil, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glColorMask", mrb_gl_color_mask, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glCompileShader", mrb_gl_compile_shader, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glCompressedTexImage2D", mrb_gl_compressed_tex_image_2d, MRB_ARGS_REQ(8));
  mrb_define_module_function(mrb, mod_gl2, "glCompressedTexSubImage2D", mrb_gl_compressed_tex_sub_image_2d, MRB_ARGS_REQ(9));
  mrb_define_module_function(mrb, mod_gl2, "glCopyTexImage2D", mrb_gl_copy_tex_image_2d, MRB_ARGS_REQ(8));
  mrb_define_module_function(mrb, mod_gl2, "glCopyTexSubImage2D", mrb_gl_copy_tex_sub_image_2d, MRB_ARGS_REQ(8));
  mrb_define_module_function(mrb, mod_gl2, "glCreateProgram", mrb_gl_create_program, MRB_ARGS_NONE());
  mrb_define_module_function(mrb, mod_gl2, "glCreateShader", mrb_gl_create_shader, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glCullFace", mrb_gl_cull_face, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteBuffers", mrb_gl_delete_buffers, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteFramebuffers", mrb_gl_delete_framebuffers, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteProgram", mrb_gl_delete_program, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteRenderbuffers", mrb_gl_delete_renderbuffers, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteShader", mrb_gl_delete_shader, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDeleteTextures", mrb_gl_delete_textures, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDepthFunc", mrb_gl_depth_func, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDepthMask", mrb_gl_depth_mask, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDepthRangef", mrb_gl_depth_rangef, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDetachShader", mrb_gl_detach_shader, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glDisable", mrb_gl_disable, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDisableVertexAttribArray", mrb_gl_disable_vertex_attrib_array, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glDrawArrays", mrb_gl_draw_arrays, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glDrawElements", mrb_gl_draw_elements, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glEnable", mrb_gl_enable, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glEnableVertexAttribArray", mrb_gl_enable_vertex_attrib_array, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glFinish", mrb_gl_finish, MRB_ARGS_NONE());
  mrb_define_module_function(mrb, mod_gl2, "glFlush", mrb_gl_flush, MRB_ARGS_NONE());
  mrb_define_module_function(mrb, mod_gl2, "glFramebufferRenderbuffer", mrb_gl_framebuffer_renderbuffer, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glFramebufferTexture2D", mrb_gl_framebuffer_texture_2d, MRB_ARGS_REQ(5));
  mrb_define_module_function(mrb, mod_gl2, "glFrontFace", mrb_gl_front_face, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGenBuffers", mrb_gl_gen_buffers, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGenerateMipmap", mrb_gl_generate_mipmap, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGenFramebuffers", mrb_gl_gen_framebuffers, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGenRenderbuffers", mrb_gl_gen_renderbuffers, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGenTextures", mrb_gl_gen_textures, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGetActiveAttrib", mrb_gl_get_active_attrib, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glGetActiveUniform", mrb_gl_get_active_uniform, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glGetAttachedShaders", mrb_gl_get_attached_shaders, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetAttribLocation", mrb_gl_get_attrib_location, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetBooleanv", mrb_gl_get_booleanv, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGetBufferParameteriv", mrb_gl_get_buffer_parameteriv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetError", mrb_gl_get_error, MRB_ARGS_NONE());
  mrb_define_module_function(mrb, mod_gl2, "glGetFloatv", mrb_gl_get_floatv, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGetFramebufferAttachmentParameteriv", mrb_gl_get_framebuffer_attachment_parameteriv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glGetIntegerv", mrb_gl_get_integerv, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGetProgramiv", mrb_gl_get_programiv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetProgramInfoLog", mrb_gl_get_program_info_log, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetRenderbufferParameteriv", mrb_gl_get_renderbuffer_parameteriv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetShaderiv", mrb_gl_get_shaderiv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetShaderInfoLog", mrb_gl_get_shader_info_log, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetShaderPrecisionFormat", mrb_gl_get_shader_precision_format, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetShaderSource", mrb_gl_get_shader_source, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetString", mrb_gl_get_string, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glGetTexParameterfv", mrb_gl_get_tex_parameterfv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetTexParameteriv", mrb_gl_get_tex_parameteriv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetUniformfv", mrb_gl_get_uniformfv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetUniformiv", mrb_gl_get_uniformiv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetUniformLocation", mrb_gl_get_uniform_location, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetVertexAttribfv", mrb_gl_get_vertex_attribfv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetVertexAttribiv", mrb_gl_get_vertex_attribiv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glGetVertexAttribPointerv", mrb_gl_get_vertex_attrib_pointerv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glHint", mrb_gl_hint, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glIsBuffer", mrb_gl_is_buffer, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsEnabled", mrb_gl_is_enabled, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsFramebuffer", mrb_gl_is_framebuffer, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsProgram", mrb_gl_is_program, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsRenderbuffer", mrb_gl_is_renderbuffer, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsShader", mrb_gl_is_shader, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glIsTexture", mrb_gl_is_texture, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glLineWidth", mrb_gl_line_width, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glLinkProgram", mrb_gl_link_program, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glPixelStorei", mrb_gl_pixel_storei, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glPolygonOffset", mrb_gl_polygon_offset, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glReadPixels", mrb_gl_read_pixels, MRB_ARGS_REQ(6));
  mrb_define_module_function(mrb, mod_gl2, "glReleaseShaderCompiler", mrb_gl_release_shader_compiler, MRB_ARGS_NONE());
  mrb_define_module_function(mrb, mod_gl2, "glRenderbufferStorage", mrb_gl_renderbuffer_storage, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glSampleCoverage", mrb_gl_sample_coverage, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glScissor", mrb_gl_scissor, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glShaderBinary", mrb_gl_shader_binary, MRB_ARGS_REQ(5));
  mrb_define_module_function(mrb, mod_gl2, "glShaderSource", mrb_gl_shader_source, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glStencilFunc", mrb_gl_stencil_func, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glStencilFuncSeparate", mrb_gl_stencil_func_separate, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glStencilMask", mrb_gl_stencil_mask, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glStencilMaskSeparate", mrb_gl_stencil_mask_separate, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glStencilOp", mrb_gl_stencil_op, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glStencilOpSeparate", mrb_gl_stencil_op_separate, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glTexImage2D", mrb_gl_tex_image_2d, MRB_ARGS_REQ(9));
  mrb_define_module_function(mrb, mod_gl2, "glTexParameterf", mrb_gl_tex_parameterf, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glTexParameterfv", mrb_gl_tex_parameterfv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glTexParameteri", mrb_gl_tex_parameteri, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glTexParameteriv", mrb_gl_tex_parameteriv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glTexSubImage2D", mrb_gl_tex_sub_image_2d, MRB_ARGS_REQ(9));
  mrb_define_module_function(mrb, mod_gl2, "glUniform1f", mrb_gl_uniform1f, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glUniform1fv", mrb_gl_uniform1fv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform1i", mrb_gl_uniform1i, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glUniform1iv", mrb_gl_uniform1iv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform2f", mrb_gl_uniform2f, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform2fv", mrb_gl_uniform2fv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform2i", mrb_gl_uniform2i, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform2iv", mrb_gl_uniform2iv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform3f", mrb_gl_uniform3f, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glUniform3fv", mrb_gl_uniform3fv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform3i", mrb_gl_uniform3i, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glUniform3iv", mrb_gl_uniform3iv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform4f", mrb_gl_uniform4f, MRB_ARGS_REQ(5));
  mrb_define_module_function(mrb, mod_gl2, "glUniform4fv", mrb_gl_uniform4fv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniform4i", mrb_gl_uniform4i, MRB_ARGS_REQ(5));
  mrb_define_module_function(mrb, mod_gl2, "glUniform4iv", mrb_gl_uniform4iv, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glUniformMatrix2fv", mrb_gl_uniform_matrix2fv, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glUniformMatrix3fv", mrb_gl_uniform_matrix3fv, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glUniformMatrix4fv", mrb_gl_uniform_matrix4fv, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glUseProgram", mrb_gl_use_program, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glValidateProgram", mrb_gl_validate_program, MRB_ARGS_REQ(1));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib1f", mrb_gl_vertex_attrib1f, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib1fv", mrb_gl_vertex_attrib1fv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib2f", mrb_gl_vertex_attrib2f, MRB_ARGS_REQ(3));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib2fv", mrb_gl_vertex_attrib2fv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib3f", mrb_gl_vertex_attrib3f, MRB_ARGS_REQ(4));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib3fv", mrb_gl_vertex_attrib3fv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib4f", mrb_gl_vertex_attrib4f, MRB_ARGS_REQ(5));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttrib4fv", mrb_gl_vertex_attrib4fv, MRB_ARGS_REQ(2));
  mrb_define_module_function(mrb, mod_gl2, "glVertexAttribPointer", mrb_gl_vertex_attrib_pointer, MRB_ARGS_REQ(6));
  mrb_define_module_function(mrb, mod_gl2, "glViewport", mrb_gl_viewport, MRB_ARGS_REQ(4));
}
